<template>
  <!-- <v-layout column align-center justify-center class="white--text">
    <v-img src="../assets/villa_main.jpeg" height="calc(100vh - 64px)"></v-img>
  ...
  <v-content>
    <section>
      <v-parallax src="../assets/villa_main.jpeg" height="600">
        <v-layout column align-center justify-center class="white--text">
        ...
        <v-row>
          ...
          <v-col cols="1" class="px-1">
            <v-select :items="items" placeholder="Guests" solo></v-select>
          </v-col>
          <v-col cols="1" class="px-1">
            ...
            <v-layout row wrap align-center>
              <v-flex xs12 md4>
                <v-card flat class="transparent">
                  ...
                  <v-card-text>
                    Cras facilisis mi vitae nunc lobortis pharetra. Nulla volutpat tincidunt ornare. Pellentesque
                    habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nullam in aliquet
                    odio. Aliquam eu est vitae tellus bibendum tincidunt. Suspendisse potenti.
                  </v-card-text>
                </v-card>
              </v-flex>
              <v-flex xs12 md4>
        ...
        <v-layout row wrap justify-center class="my-12">
          <v-flex xs12 sm4>
            <v-card flat class="transparent">
              ...
              <v-card-text>
                ...
                morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nullam in aliquet odio. Aliquam
                eu est vitae tellus bibendum tincidunt. Suspendisse potenti.
              </v-card-text>
            </v-card>
          </v-flex>
          <v-flex xs12 sm4 offset-sm1>
            <v-card flat class="transparent">
              ...
              <v-card-text
                >Cras facilisis mi vitae nunc lobortis pharetra. Nulla volutpat tincidunt ornare.</v-card-text
              >
